...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="container">
  	<div class="box">
      <h2 style="text-align: center;">DATA DIRI <?php echo $this->session->userdata("nama_user") ?> </h2>
      <br><br>
        ...
        <tbody>
          <?php $i = 0;?>
            ...
            <form action="">
              ...
              <!--Button Aksi-->
              <td>
                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#edit<?=$row['kode_pasien']?>">Ubah</button>
              </td>
              </tr>
            </form>
            <?php } ?>
      ...
      <br>
      <div>
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#edit1">Tambah Data Diri</button>
      </div>
    </div>
  </div>
