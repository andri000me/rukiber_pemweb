    ...
    <div class="row">
        <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="<?= base_url(); ?>dokter" class="list-group-item"><i class="fa fa-dashboard"></i> Kelola Data Dokter </a>
              <a href="<?= base_url(); ?>obat" class="list-group-item"><i class="fa fa-book"></i> Kelola Data Obat </a>
              <a href="<?= base_url(); ?>pasienn" class="list-group-item"><i class="fa fa-folder"></i> Kelola Data Pasien </a>
              <a href="#" class="list-group-item"><i class="fa fa-comments-o"></i> Lihat Booking Dokter </a>
            </div>
        </div>
        <div class="col-md-9">
